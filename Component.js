jQuery.sap.declare("com.sap.products.Component");
jQuery.sap.require("com.sap.products.MyRouter");

sap.ui.core.UIComponent.extend("com.sap.products.Component", {
	metadata: {
		name: "TDG Demo App",
		version: "1.0",
		includes: [],
		...
		rootView: "com.sap.products.view.App",

		config: {
			resourceBundle: "i18n/messageBundle.properties",
			serviceConfig: {
				name: "ODataDemo",
				serviceUrl: "http://services.odata.org/V2/(S(11adut1ba5ftryxkhykvnuni))/OData/OData.svc/"
			}
		},

		routing: {
			config: {
				routerClass: com.sap.products.MyRouter,
				viewType: "XML",
				viewPath: "com.sap.products.view",
	...
	init: function() {
		...
		var oRootPath = jQuery.sap.getModulePath("com.sap.products");
		...
		var oModel;
		var externalURL = com.sap.products.dev.devapp.externalURL;
		var appContext;
		if (com.sap.products.dev.devapp.devLogon) {
			appContext = com.sap.products.dev.devapp.devLogon.appContext;
		}
