jQuery.sap.require("com.sap.products.util.Formatter");
jQuery.sap.require("com.sap.products.util.Controller");

com.sap.products.util.Controller.extend("com.sap.products.view.Detail", {
	...
	onRouteMatched: function(oEvent) {
		...
		jQuery.when(this.oInitialLoadFinishedDeferred).then(jQuery.proxy(function() {
			...
			oIconTabBar.getItems().forEach(function(oItem) {
				oItem.bindElement(com.sap.products.util.Formatter.uppercaseFirstChar(oItem.getKey()));
			});
	...
	showEmptyView: function() {
		this.getRouter().myNavToWithoutHash({
			...
			targetViewName: "com.sap.products.view.NotFound",
			targetViewType: "XML"
		});
	},
