jQuery.sap.declare("com.sap.products.dev.devapp");
jQuery.sap.require("com.sap.products.dev.devlogon");

com.sap.products.dev.devapp = {
	smpInfo: {},
	externalURL: null,
	...
	onDeviceReady: function() {
		if (window.sap_webide_FacadePreview) {
			...
			var that = com.sap.products.dev.devapp;
			$.getJSON(".project.json", function(data) {
				...
				if (that.smpInfo.server && that.smpInfo.server.length > 0) {
					...
					that.devLogon = new com.sap.products.dev.devlogon();
